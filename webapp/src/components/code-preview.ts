  ...
  template() {
    return html`
      ...
      <div class="code-content">
        ...
        <div class="code-line"><span class="line-number">10</span> <span class="line-code">&nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">permission</span>[greeter] <span class="function">sayHello</span>(greetee: Text) <span class="keyword">returns</span> Text | greeting {</span></div>
        <div class="code-line"><span class="line-number">11</span> <span class="line-code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">become</span> greeted;</span></div>
        <div class="code-line"><span class="line-number">12</span> <span class="line-code">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="keyword">return</span> <span class="string">"Hi "</span> + greetee + <span class="string">", "</span> + <span class="function">getUsername</span>(greeter) + <span class="string">" sends greetings!"</span>;</span></div>
